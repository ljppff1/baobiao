...
import com.soloman.org.cn.adapter.IndentAdapter.ViewHolder;
...
public class IndentsAdapter extends BaseAdapter
{
	private ArrayList<Indent> lt;
	private Context context;

	public IndentsAdapter(ArrayList<Indent> lt, Context context)
	{
		super();
		this.lt = lt;
	...
	public View getView(final int position, View convertView, ViewGroup arg2)
	{
		...
		holder.item_rl_task_clicks.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v)
			{
				...
				System.out.println(indents.getCan_cancel());
