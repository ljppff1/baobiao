...
import com.soloman.org.cn.ui.ActHost;
...
public class MyReceiver extends BroadcastReceiver
{
	...
	public void onReceive(Context context, Intent intent)
	{
		...
		preferences = PreferenceUtils.getInstance(context,
				...
				.getAction()))
		{
			...
			Intent i = null;
			if (!ExampleUtil.isEmpty(type))
			{
				try
				{
					JSONObject extraJson = new JSONObject(type);
					if (null != extraJson && extraJson.length() > 0)
					{
						if (extraJson.has("type"))
						{
							i = new Intent(context, ActDiscount.class);
						} else
						{
							i = new Intent(context, ActMessageListDetails.class);
						}
